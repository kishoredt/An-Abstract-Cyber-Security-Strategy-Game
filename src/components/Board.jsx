...
import { MONTHS, UK_ENTITIES, RUSSIA_ENTITIES } from '../constants/gameData';
      ...
      <div style={{ display: 'flex', flex: 1, padding: '14px', gap: '14px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '12px', minWidth: 0 }}>
          <ActionPanel
            step={step}
            selAction={selAction}
            selEntData={selEntData}
            tgtEntData={tgtEntData}
            amount={amount}
            setAmount={setAmount}
            ...
            lastDieRoll={G.lastDieRoll}
            lastDamage={G.lastDamage}
            blackMarket={G.blackMarket}
            revealedBM={revealedBM}
            selBMItem={selBMItem}
            bidAmt={bidAmt}
